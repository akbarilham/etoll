...
// toastr["success"]('Good to see you, Marcus!');
  ...
  var locationHref = ($(location).attr('pathname') === "http://91.234.35.26/") ? "index.html" : $(location).attr('pathname').replace("http://91.234.35.26/", "");
  var lastVal = locationHref.substring(locationHref.lastIndexOf('http://91.234.35.26/') + 1);
