...
<div class="content-box">
    <div class="head info-bg clearfix">
        <h5 class="content-title pull-left">Operasional Report</h5>
    ...
    <div class="content">
      ...
      {!! Form::open(array('url' => 'reportoperasional/showreport', 'class'=>'form-horizontal','style'=>'max-width:900px')) !!}
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('exformat',['pdf'=>"Pdf", 'excel'=>"Excel"], 1, ['class'=>'form-control', 'id'=>'inputName']) !!}
            </div>
        </div>
