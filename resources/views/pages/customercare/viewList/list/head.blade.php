                 ...
                 <header class="panel-heading panel-heading-custom-padding">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                            {!! Form::select('searchby', ['ticket_number'=>'Ticket Number'], null, ['class' => 'form-control',  'onchange' => 'setList("list", "")' ]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::select('perpage', [5=>5, 10=>10, 30=>30, 100=>100], null, ['class' => 'form-control',  'onchange' => 'setList("list", "")' ]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::select('status', [0=>'ALL Status', 141=>'OPEN', 142=>'PENDING', 143=>'CLOSED'], null, ['class' => 'form-control',  'onchange' => 'setList("list", "")' ]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::select('priority', [0=>'ALL Priority', 140=>'HIGH', 139=>'MEDIUM', 138=>'LOW'], null, ['class' => 'form-control',  'onchange' => 'setList("list", "")' ]) !!}
                        </div>
                        {!! Form::close() !!}
...
<script type="text/javascript">
  ...
  function doCustomerCareViewIssue(request, id){
        ...
        var id = id || '';
        var url = $('#url').val() + '/customercare/view';
