<div>
    <h5>{!! trans('master.new-data-operator-form') !!}</h5>
    <hr/>
    {!! Form::open(['url' => 'operator/save', 'role' => 'form', 'data-validate' => 'parsley']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('name',null, ['class'=>'form-control', 'id'=>'inputName', 'placeholder'=>'Operator Name', 'required'=>true]) !!}
        </div>
        <div class="form-group">
