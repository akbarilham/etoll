<div>
    <h5>{!! trans('master.edit-data-obu-fare-form') !!}</h5>
    <hr/>
    {!! Form::open(['url' => 'fare/update', 'role' => 'form', 'data-validate' => 'parsley']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('name',$result->dataQuery->name, ['class'=>'form-control', 'id'=>'inputName', 'placeholder'=>'Fare Name', 'required' => true]) !!}
        </div>
        <div class="form-group">
